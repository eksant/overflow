...
<div>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <router-link to="/" class="navbar-brand" style="cursor:pointer;color:white">Simple HacktivOverflow</router-link>
      ...
      this.setLogin((e) => {
        this.$axios.get('/auth', {
          ...
          .then(({
            ...
            this.$notify({
              type: 'success',
              text: 'Welcome to Simple HacktivOverFlow',
            });
          }).catch((err) => {
            console.error(err);
          });
